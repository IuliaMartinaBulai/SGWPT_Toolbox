%--------------------------------------------------------------------------
% File:  sgwpt_best_basis_run_rfMRI_100_norm_meyer.m
%
% Goal: Main file for the reconstruction of the normalized signal rfMRI_100 
% with lev0, lev1, lev2, and the five best basis using Meyer filters
%
...
clear D;
cd ../data
filename = ('sgwpt_best_basis_run_rfMRI_100_norm_meyer');
save(filename);
toc