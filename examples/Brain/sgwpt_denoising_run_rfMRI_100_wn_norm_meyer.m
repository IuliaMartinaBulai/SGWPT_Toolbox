%--------------------------------------------------------------------------
% File:  sgwpt_denoising_run_rfMRI_100_wn_norm_meyer.m
%
% Goal: Main file for the denoising of the normalized noisy signal 
% for the Shannon best basis using Meyer filters (for the remaining 
...
clear all
tic
load('sgwpt_best_basis_run_rfMRI_100_wn_norm_meyer')
...
[tau_T1_33, best_basis_T1_thresholded_33] = sgwpt_thresholding(prc_range_1, best_basis_T1);
...
best_basis_T1_thresholded_33_new = cellfun(@(x) max(0,x - tau_T1_33)-max(0,-x-tau_T1_33),...
    best_basis_T1_thresholded_33, 'un', 0);
...
[tau_T2_33, best_basis_T2_thresholded_33] = sgwpt_thresholding(prc_range_1, best_basis_T2);
...
% substract tau from the coefficients
best_basis_T2_thresholded_33_new = cellfun(@(x) max(0,x - tau_T2_33)-max(0,-x-tau_T2_33),...
    best_basis_T2_thresholded_33, 'un', 0);
...
[tau_T3_33, best_basis_T3_thresholded_33] = sgwpt_thresholding(prc_range_1, best_basis_T3);
...
% substract tau from the coefficients
best_basis_T3_thresholded_33_new = cellfun(@(x) max(0,x - tau_T3_33)-max(0,-x-tau_T3_33),...
    best_basis_T3_thresholded_33, 'un', 0);
...
[tau_T4_33, best_basis_T4_thresholded_33] = sgwpt_thresholding(prc_range_1, best_basis_T4);
...
% substract tau from the coefficients
best_basis_T4_thresholded_33_new = cellfun(@(x) max(0,x - tau_T4_33)-max(0,-x-tau_T4_33),...
    best_basis_T4_thresholded_33, 'un', 0);
...
[tau_T5_33, best_basis_T5_thresholded_33] = sgwpt_thresholding(prc_range_1, best_basis_T5);
...
% substract tau from the coefficients
best_basis_T5_thresholded_33_new = cellfun(@(x) max(0,x - tau_T5_33)-max(0,-x-tau_T5_33),...
    best_basis_T5_thresholded_33, 'un', 0);
...
% [tau_T6_33, best_basis_T6_thresholded_33] = sgwpt_thresholding(prc_range_1, best_basis_T6)
...
% substract tau from the coefficients
% best_basis_T6_thresholded_33_new = cellfun(@(x) max(0,x - tau_T6_33)-max(0,-x-tau_T6_33),...
%     best_basis_T6_thresholded_33, 'un', 0);
...
tic
fprintf('Recover the denoised signal from the best basis with Shannon energy (33)\n');
% inverse using Chebyshev polynomial of Laplacian applied to best basis
% thresholded
r4_T1_thresholded_33 = sgwt_inverse(best_basis_T1_thresholded_33_new,L,coef_bb_T1,arange);
% r4_T2_thresholded_33 = sgwt_inverse(best_basis_T2_thresholded_33_new,L,coef_bb_T2,arange);
% r4_T3_thresholded_33 = sgwt_inverse(best_basis_T3_thresholded_33_new,L,coef_bb_T3,arange);
% r4_T4_thresholded_33 = sgwt_inverse(best_basis_T4_thresholded_33_new,L,coef_bb_T4,arange);
% r4_T5_thresholded_33 = sgwt_inverse(best_basis_T5_thresholded_33_new,L,coef_bb_T5,arange);
% %r4_T6_thresholded_33 = sgwt_inverse(best_basis_T6_thresholded_33_new,L,coef_bb_T6,arange);
...
clear D;
cd ../data
filename = ('sgwpt_denoising_run_rfMRI_100_wn_norm_meyer');
save(filename);
