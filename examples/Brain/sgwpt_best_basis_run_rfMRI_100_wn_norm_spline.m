%--------------------------------------------------------------------------
% File:  sgwpt_best_basis_run_rfMRI_100_wn_norm_spline.m
%
% Goal: Main file for the reconstruction of the normalized noisy signal 
% rfMRI_100 with lev0, lev1, lev2, and the five best basis using spline
% filters
%
...
clear D;
cd ../data
filename = ('sgwpt_best_basis_run_rfMRI_100_wn_norm_spline');
save(filename);
toc